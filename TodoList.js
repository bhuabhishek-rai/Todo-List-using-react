  ...
  return (
    <>  
     ...
     <div className='reset_container'>
        <h2  id="A101" className='contained-modal-title-vcenter2'>Todo List</h2>
        <div className='icon'>
     ...
     <div class="vertical-center">
      <button  id="A100" className='btn_area' variant="primary" onClick={handleShow}>Add</button>
     </div>
    </div>
    ...
    <Modal {...props}
      ...
      <Modal.Body>
        ...
        <Form.Label id="A105">Your thoughts 🤔</Form.Label>
        ...
        <Modal.Footer>
          ...
          <Button   id="A104" variant="secondary" onClick={handleClose}>
            Close
          </Button>
          
          <Button id="A103" variant="primary" onClick={addActivity}>
            Save Changes
          </Button>
          </div>
        </Modal.Footer>
